#
#  Be sure to run `pod spec lint APPHelp.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "boli"
  # s.authors            = { "boli" => "libo198615@163.com" }
  # s.social_media_url   = "http://twitter.com/boli"
